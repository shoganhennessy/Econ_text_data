...
#### Datafiles
# Authors in the NBER
NBER_authors.data <- fread('../Data/NBER_data/Authors_data/Authors_data.csv')
# Information on their appointment in the NBER
NBER_appointment.data <- fread('../Data/NBER_data/Appointment_data/Appointment_data.csv')
# Authors in RePEc
RePEc_authors.data <- fread('../Data/RePEc_data/Economists_data/Economists_repec_data.csv')
```
