...
allignment with causal or theortical papers.
...
Papers.data %>% 
  ...
  reshape(timevar = 'paper_type',
          times = c('causal', 'theoretical'),
          varying = c('causal', 'theoretical'),
...
To see in granual detail, the words at the extreme of these sentiments within published
