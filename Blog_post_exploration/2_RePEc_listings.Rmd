...
Forunately, [Research Papers in Economics (RePEc)'s Ideas](https://ideas.repec.org/) provides a large listing of economics research which I can use as a complement to the NBER listings.
...
```
RePEc lists information on `r nrow(Economists.data)` economists 
...
[2012](https://www.nber.org/papers/w18635)) consider only subsamples for example.
Lucky for us, computing power and open access to information on published research
have advanced enough to allow analyse of a more complete set of the data.
```{r, echo=T}
# Get the top Journal
...
The set is certainly much larger than te NBER listings, but it is so far unclear whether it is 
