...
Restate equation for the event by hand: author and/or year fixed effects.

Equation written in https://www.codecogs.com/latex/eqneditor.php
see page 4 of https://scholar.harvard.edu/files/borusyak/files/event_studies_may8_website.pdf for event study configurations.
