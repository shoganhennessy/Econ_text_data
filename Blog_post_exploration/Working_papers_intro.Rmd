...
The ten most common words are almost identical across publication outcome, yet this measure is crude.

Next do a relative word usage textual analysis along the publication outcome.



section on measure of mathematical/empirical words across publication outcome.
Follow the papers which include the use of the word ``data'' in the abstract (and/or similar words).
Are they new?  are they just in a few areas?
Are they rising in publication rate?
